...
import { offerImage, offerInside, TypeCard, Offer } from '../../const.tsx';
...
function OfferCard({offers} : OfferProps) {
  ...
  const rating = offer?.rating / 0.0337;
      ...
      <div className="container">
        <section className="near-places places">
          ...
          <div className="near-places__list places__list">
            <Card typeCard={TypeCard.Offer} isPremium={false} image="img/room.jpg" price={80} width="80%" text='Wood and stone place' type='Room'/>
            <Card typeCard={TypeCard.Offer} isPremium={false} image="img/apartment-02.jpg" price={132} width="80%" text='Canal View Prinsengracht' type='Apartment'/>
            <Card typeCard={TypeCard.Offer} isPremium image="img/apartment-03.jpg" price={180} width="100%" text='Nice, cozy, warm big bed apartment' type='Apartment'/>
          </div>
        </section>
      </div>
    </main>
